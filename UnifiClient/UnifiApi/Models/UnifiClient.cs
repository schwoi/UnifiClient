...
namespace UnifiApi.Models
{
    public class UnifiClient
    {
        ...
        public int LastSeenByUap { get; set; }

        [JsonProperty(PropertyName = "_last_seen_by_ugw")]
        public int LastSeenByUgw { get; set; }
        ...
        public int DpiStatsLastUpdated { get; set; }
        ...
        public int LatestAssocTime { get; set; }
